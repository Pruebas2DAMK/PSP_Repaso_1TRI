...
class Hilo1  implements Runnable { //Clase que implementa runnable
    private int id, n;//atributos

    public Hilo1(int id, int n) {
        this.id = id;
        this.n = n;
    }
...
class Hilo2 extends Thread {//Clase que implementa runnable
    private int id, n;//atributos

    public Hilo2(int id, int n) {
        this.id = id;
        this.n = n;
    }
...
class Ejercicio2_2 {
    public static void main(String[] args) {
        ...
        Thread hilo1 = new Thread(new Hilo1(1, 10));//Implementa runnable
        Thread hilo2 = new Hilo2(2, 10);//Hereda de Thread
